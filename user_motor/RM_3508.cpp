...
void Motor_RM_3508::Ctrl_Reset() {
    MotorPID.Vel_PID = (PID_s){VEL_KP_3508,VEL_KI_3508,VEL_KD_3508,2.5,2000,CURRENT_MAX_3508,0,0,0,0,0};
    MotorPID.Pos_PID = (PID_s){POS_KP_3508,POS_KI_3508,POS_KD_3508,0.000,10,MotorPID.Pos_PID.ctrl_max,0,0,0,0,0};
